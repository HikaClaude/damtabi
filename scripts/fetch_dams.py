    ...
    "bases": {
        "irrigation": {
            ...
            "bins": [
                ...
                {"min": 80, "max": 95, "label": "80–95%", "color": "#2f8fd0"},
                {"min": 60, "max": 80, "label": "60–80%", "color": "#3f9e6a"},
                {"min": 40, "max": 60, "label": "40–60%", "color": "#e2701c"},
                {"min": None, "max": 40, "label": "40%未満（少ない）", "color": "#c31616"},
            ],
        },
        "effective": {
            "label": "有効貯水率",
            ...
            "bins": [
                ...
                {"min": 40, "max": 60, "label": "40–60%", "color": "#2f8fd0"},
                {"min": 25, "max": 40, "label": "25–40%", "color": "#3f9e6a"},
                {"min": 10, "max": 25, "label": "10–25%", "color": "#e2701c"},
                {"min": None, "max": 10, "label": "10%未満", "color": "#c31616"},
            ],
        },
    },
